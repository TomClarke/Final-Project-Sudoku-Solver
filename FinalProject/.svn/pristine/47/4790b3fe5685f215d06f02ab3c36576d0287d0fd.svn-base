...
public class Network {
	...
	/** The variable list containing all the variables */
	...
	/**
	 * Sets the board solved to the boolean of solved.
	 *
	 * @param solved the new board solved
	 */
	...
	/**
	 * Setup a new board that contains the values within the variable list
	 *
	...
	/**
	 * Solve creates a new instance of the constraints and sets the algorithm specified by the 
	 * user. then takes the value returned from those classes of the solved board and sets the
	 * solved board as 
	 * the newboard and the board si set to solved.
	 *
